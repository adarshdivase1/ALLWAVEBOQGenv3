      ...
      <div className="bg-white dark:bg-slate-800 p-6 rounded-lg border border-slate-200 dark:border-slate-700" id="boq-display-section">
        ...
        {boq && boq.length > 0 ? (
            ...
            <table className="min-w-full divide-y divide-slate-200 dark:divide-slate-700 border-separate border-spacing-0">
                ...
                <tr>
                    {['Item Description', 'Brand', 'Model', 'Qty', 'Unit Price (USD)', 'Item Margin (%)', 'Final Unit Price', 'Final Total Price', 'Actions'].map(header => (
                ...
                {categoryOrder.map(category => (
                    <tbody key={category} className="bg-white dark:bg-slate-800">
                        <tr className="bg-slate-200 dark:bg-slate-700/50">
                            <th colSpan={9} className="px-4 py-2 text-left text-sm font-semibold text-slate-900 dark:text-slate-200">
                                {category}
                            </th>
                        </tr>
                ...
                <tfoot className="bg-slate-100 dark:bg-slate-900">
                    <tr>
                        <td colSpan={7} className="px-6 py-3 text-right text-sm font-medium text-slate-500 dark:text-slate-300 uppercase">Subtotal</td>
                    ...
                    <tr>
                        <td colSpan={7} className="px-6 py-3 text-right text-sm font-medium text-slate-500 dark:text-slate-300 uppercase">Total Margin</td>
                    ...
                    <tr>
                        <td colSpan={7} className="px-6 py-3 text-right text-sm font-medium text-slate-500 dark:text-slate-300 uppercase">GST (18%)</td>
                    ...
                    <tr className="border-t-2 border-slate-200 dark:border-slate-700">
                        <td colSpan={7} className="px-6 py-3 text-right text-sm font-bold text-slate-900 dark:text-white uppercase">Grand Total</td>
